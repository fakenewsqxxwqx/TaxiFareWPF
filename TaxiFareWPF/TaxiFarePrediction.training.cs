...
namespace TaxiFareWPF
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\yy176\source\repos\TaxiFareWPF\TaxiFareWPF\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=67,NumberOfTrees=143,MaximumBinCountPerFeature=150,FeatureFraction=0.707562197469609,LearningRate=0.999999776672986,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",DiskTranspose=false}));
